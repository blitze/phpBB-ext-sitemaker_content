...
$lang = array_merge($lang, array(
	...
	'AUTHOR_INFO_EXPLAIN'		=> 'About the topic author',
	'AUTHOR_CONTENTS'			=> 'Author Contents',
	'AUTHOR_CONTENTS_EXPLAIN'	=> 'Other topics posted by the topic author (titles only)',
	...
	'COMMENTS_TYPE_EXPLAIN'		=> 'Select the comment system to use or none if you do not want to allow comments for this content type',
	...
	'TILES_OFFSET'				=> 'Offset',
	'TILES_OFFSET_EXPLAIN'		=> 'The number of pages to load on scroll before displaying a “Load more” button:<br /><strong>0</strong>: No “Load More” button<br /><strong>1</strong>: Show button for all pages',
	'TITLE'						=> 'Title',
	'TOO_LARGE'					=> 'Too large',
	'TOO_LONG'					=> 'Too long',
	'TOO_SHORT'					=> 'Too short',
	...
	'TOPIC_BLOCKS'				=> 'Topic Blocks',
	'TOPIC_BLOCKS_AVAILABLE'	=> 'Available',
	'TOPIC_BLOCKS_EXPLAIN'		=> 'These are additional bits of content that will be displayed when viewing a topic.<br />Use drag/drop to select and/or reorder the items',
	'TOPIC_BLOCKS_SELECTED'		=> 'Selected',
	'TOPIC_COMMENTS'			=> 'Comments',
	'TOPIC_DATA'				=> 'Topic Data',
	'TOPIC_DATE'				=> 'Topic Date',
	'TOPIC_ID'					=> 'Topic ID',
	'TOPIC_TITLE'				=> 'Topic Title',
	'TOPIC_UNIX_TIME'			=> 'Topic Unix Time',
	'TOPIC_URL'					=> 'Topic URL',
