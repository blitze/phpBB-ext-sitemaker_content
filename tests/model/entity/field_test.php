...
class field_test extends \phpbb_test_case
{
	...
	public function accessors_and_mutators_test_data()
	{
		return array(
			...
			array('field_settings', array(), '', array(), '{"size":"large","editor":"1","max_chars":"100"}', array('size' => 'large', 'editor' => '1', 'max_chars' => '100')),
			array('field_mod_only', false, true, true, false, false),
			array('field_required', false, true, true, false, false),
			array('field_summary_show', false, true, true, false, false),
			array('field_detail_show', false, true, true, false, false),
			array('field_summary_ldisp', false, true, true, false, false),
			array('field_detail_ldisp', false, true, true, false, false),
	...
	function test_to_array()
	{
		$block = new field(array(
			...
			'field_type'			=> 'textarea',
			'field_settings'		=> array('size' => 'large', 'editor' => 1, 'max_chars' => 200),
		...
		$to_db_expected = array(
			...
			'field_explain'			=> 'my [b]test[/b] field',
			'field_type'			=> 'textarea',
			'field_settings'		=> '{"size":"large","editor":1,"max_chars":200}',
			'field_mod_only'		=> false,
			'field_required'		=> true,
			'field_summary_show'	=> true,
			'field_detail_show'		=> true,
